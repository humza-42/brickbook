...
class _$ApiErrorImpl extends _ApiError {
  ...
  @override
  String toString() {
    return 'ApiError(message: $message, type: $type, statusCode: $statusCode, validationErrors: $validationErrors, originalError: $originalError)';
  }
...
abstract class _ApiError extends ApiError {
  const factory _ApiError(
      ...
      final int? statusCode,
      final Map<String, dynamic>? validationErrors,
      final Object? originalError}) = _$ApiErrorImpl;
